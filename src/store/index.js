...
export default createStore({
  ...
  getters: {
    ...
    backgrounds(state, getters){
      if(state.themeBack === 1){
        return getters.backgroundsOne
      }
      if(state.themeBack === 2){
        return getters.backgroundsTwo
      }
      if(state.themeBack === 3){
        return getters.backgroundsThree
      }
    }
  ...
  mutations: {
    ...
    changeColorBackgrSecond(state, newColorSecond){
